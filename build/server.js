...
//cors serve para defenirmos qual dominio pode fazer requisições
app.use((0, cors_1.default)());
const prisma = new client_1.PrismaClient();
/*
    Query: ... Parametros após o parâmetro de interrogração (?id=2)
    Route: ... São parâmetros não nomeados (blog.com/post/como-criar-uma-api-em-node)
    Body: ...  Enviar várias informações (geralmente usado para envio de formulário e informações sensíveis, pois nao fica na URL)
*/
